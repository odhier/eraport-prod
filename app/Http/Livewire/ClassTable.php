    ...
    public function columns()
    {
        ...
        return [
            ...
            Column::callback(['id'], function ($id) {
                return "
                <a target='_blank' href='/raport/cetak_pdf/{$this->class->tahun_ajaran_id}_{$this->class->id}_{$this->selected_semester}_{$id}' class='border-orange-500 border-opacity-75 border-2 rounded-xl p-1 shadow-sm text-orange-500 hover:text-orange-500 hover:no-underline cursor-pointer'>Print Nilai <i class='fas fa-print'></i></a><br/><br/>
                <a target='_blank' href='/raportSMP/cetak_pdf/{$this->class->tahun_ajaran_id}_{$this->class->id}_{$this->selected_semester}_{$id}' class='border-green-500 border-opacity-75 border-2 rounded-xl p-1 shadow-sm text-green-500 hover:text-green-600 hover:no-underline cursor-pointer'>Print Nilai (SMP) <i class='fas fa-print'></i></a>
                ";
