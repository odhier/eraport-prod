...
<body>
    <div class="header w-100 position-relative">
        ...
        <div class="header-title text-center">
            <p style="color:green">SEKOLAH MENENGAH PERTAMA ISLAM TERPADU IKHTIAR</p>
            <p style="color:green">SMPIT IKHTIAR</p>
            <p style="color: red">ISLAMIC FULL DAY SCHOOL</p>
            <p style="font-size: .6rem"><i>Jl. Sunu (Kompleks UNHAS Baraya), Telp. (0411) 3690844, email : SMP-IT_ikhtiar@yahoo.co.id Makassar - Sulawesi Selatan</i></p>
        </div>
    </div>
            ...
            <td style="width:65%;vertical-align:top;">
                <table class="table-data">
                    ...
                    <tr>
                        <td>Nama Sekolah</td>
                        <td>:</td>
                        <td>SEKOLAH MENENGAH PERTAMA ISLAM TERPADU IKHTIAR</td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td class="text-center" style="width: 100%;" colspan="2">
                ...
                <ul>
                    ...
                    <li style="height: 65px;background: #fff; width:100%;border-radius: 5px;
                    background-position: center;
                    background-repeat: no-repeat;
                    background-size: contain;"></li>
