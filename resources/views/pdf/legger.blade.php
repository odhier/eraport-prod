    ...
    <table class="table-bordered w-100" style="font-size: .6rem">
        <thead>
            ...
            <tr>
                ...
                <th>@if($nilai['kkm']) {{round($nilai['kkm']->value)}} @else {{"-"}} @endif </th>
                @endforeach
        ...
        <tfoot class="nobreak">
            ...
            <tr class="nobreak">
                <td style="height: 0px;padding:0;background:#eee" class="nobreak">Keterampilan</td>
                @foreach ($student_class->nilai as $index => $nilai)
                    <td class="nobreak"style="height: 0px; padding: 0px;text-align: center;background:#eee">{{round($sum['terendah_4'][$index])}}</td>
                @endforeach
                <td class="nobreak" style="padding: 0;height: 0;text-align:center;background:#eee">{{$students_class->min('jumlah_4')}}</td>
                <td class="nobreak" style="padding: 0;height: 0;text-align:center;background:#eee">{{round($students_class->min('NR_4'))}}</td>
            </tr>
            <tr class="rowspan w-100 nobreak">
                <td class="nobreak" rowspan="2" colspan="2" style="background:#eee">Nilai Tertinggi</td>
                <td class="nobreak" style="height: 0px;padding:0;background:#eee">Pengetahuan</td>
                @foreach ($student_class->nilai as $index => $nilai)
                    <td class="nobreak" style="height: 0px; padding: 0px;text-align: center;background:#eee">{{round($sum['tertinggi_3'][$index])}}</td>
                @endforeach
                <td class="nobreak" style="padding: 0;height: 0;text-align:center;background:#eee">{{$students_class->max('jumlah_3')}}</td>
                <td class="nobreak" style="padding: 0;height: 0;text-align:center;background:#eee">{{round($students_class->max('NR_3'))}}</td>
                <td class="nobreak" style="padding: 0;height: 0;text-align:center;background:#eee" rowspan="2">{{round($students_class->max('NRAll'))}}</td>
            </tr>
            <tr class="nobreak">
                <td style="height: 0px;padding:0;background:#eee" class="nobreak">Keterampilan</td>
                @foreach ($student_class->nilai as $index => $nilai)
                    <td style="height: 0px; padding: 0px;text-align: center;background:#eee" class="nobreak">{{round($sum['tertinggi_4'][$index])}}</td>
                @endforeach
                <td style="padding: 0;height: 0;text-align:center;background:#eee" class="nobreak">{{$students_class->max('jumlah_4')}}</td>
                <td class="nobreak" style="padding: 0;height: 0;text-align:center;background:#eee">{{round($students_class->max('NR_4'))}}</td>
            </tr>
